...
class SanPham extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $tinhchat_arr = [
            ['loai_go' => 'Gỗ Sồi', 'kich_thuoc' => '100x200', 'mau_sac' => 'Nâu nhạt', 'bao_hanh' => '2 năm'],
            ['loai_go' => 'Gỗ Thông', 'kich_thuoc' => '150x250', 'mau_sac' => 'Vàng', 'bao_hanh' => '1 năm'],
            ['loai_go' => 'Gỗ Lim', 'kich_thuoc' => '200x300', 'mau_sac' => 'Nâu đậm', 'bao_hanh' => '2 năm'],
            ['loai_go' => 'Gỗ Tần Bì', 'kich_thuoc' => '250x350', 'mau_sac' => 'Xanh nhạt', 'bao_hanh' => '3 năm'],
            ['loai_go' => 'Gỗ Hương', 'kich_thuoc' => '300x400', 'mau_sac' => 'Đỏ', 'bao_hanh' => '2 năm'],
            ['loai_go' => 'Gỗ Gụ', 'kich_thuoc' => '350x450', 'mau_sac' => 'Nâu đỏ', 'bao_hanh' => '1 năm'],
            ['loai_go' => 'Gỗ Trắc', 'kich_thuoc' => '400x500', 'mau_sac' => 'Đen', 'bao_hanh' => '2 năm'],
            ['loai_go' => 'Gỗ Mun', 'kich_thuoc' => '450x550', 'mau_sac' => 'Đen bóng', 'bao_hanh' => '1 năm'],
            ['loai_go' => 'Gỗ Xoan Đào', 'kich_thuoc' => '500x600', 'mau_sac' => 'Hồng nhạt', 'bao_hanh' => '4 năm'],
            ['loai_go' => 'Gỗ Căm Xe', 'kich_thuoc' => '550x650', 'mau_sac' => 'Vàng nhạt', 'bao_hanh' => '2 năm'],
            ['loai_go' => 'Gỗ Giáng Hương', 'kich_thuoc' => '600x700', 'mau_sac' => 'Nâu sẫm', 'bao_hanh' => '3 năm'],
            ['loai_go' => 'Gỗ Đỏ', 'kich_thuoc' => '650x750', 'mau_sac' => 'Đỏ đậm', 'bao_hanh' => '1 năm'],
        ];
        ...
        for ($i = 0; $i < 8; $i++) {
            ...
            $remaining_images = array_values(array_diff($hinh_arr, [$hinh]));

            $hinh_1 = array_splice($remaining_images, array_rand($remaining_images), 1)[0];

            $remaining_images = array_values(array_diff($remaining_images, [$hinh_1]));

            $hinh_2 = array_splice($remaining_images, array_rand($remaining_images), 1)[0];
            ...
            DB::table('sanpham')->insert([
                ...
                'thong_tin'=>' - Dài 206cm x Rộng 166/ 186cm (Phù hợp với nệm 160/180cm x 2m)<br>

                    - Cao đến đầu giường 95cm<br>

                    Khoảng trống đầu giường cao 17cm<br><br>

 

                   Chất liệu:</strong>

                    - Thân giường: Gỗ tràm tự nhiên<br>
