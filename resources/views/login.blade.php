        ...
        <div class="row justify-content-center">
          <div class="col-md-6 col-lg-4">
            <div class="login-wrap p-0">
              ...
              <form action="{{url('/dangnhap')}}" method="post" class="signin-form">
                @csrf
                @if ($errors->any())
              ...
              <div class="d-flex justify-content-between mt-3">
                <a href="/dangky" style="color: #fff;">Chưa có tài khoản?</a>
                <a href="#" style="color: #fff;">Quên mật khẩu</a>	
              </div>
              <p class="w-100 text-center mt-4">&mdash; Hoặc Đăng Nhập Với &mdash;</p>
