...
<div class="col-md-10 p-4">
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('danhmuc_nv.create') }}">
  ...
  @endif
        <div class="card-body">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <form class="col-lg-4 col-md-6 d-flex" action="{{ route('danhmuc_nv.index') }}" method="GET">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $danhmuc->loai }}</td>
                            <td>
                                <a href="{{ route('danhmuc_nv.edit', $danhmuc->id_loaisp) }}">
                                    <button class="btn btn-warning btn-sm">Chỉnh sửa</button>
                                </a>
                                <form action="{{ route('danhmuc_nv.destroy', $danhmuc->id_loaisp) }}" method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
