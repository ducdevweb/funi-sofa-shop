...
<div class="col-md-10 p-4">
      ...
      @foreach ($dem_sp as $sp)
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="card text-white bg-warning">
                <a href="/nhanvien/sp_danhmuc/{{$sp->id_loaisp}}"><img class="product-img" src="{{$sp->danhmuc->hinh}}" alt=""></a>
    ...
    <div class="row mb-4 align-items-center">
        ...
        <div class="col-lg-2 col-md-6 mb-2">
            <div class="btn-group w-100">
                ...
                <ul class="dropdown-menu">
                    @foreach ($nsx as $n)
                    <li><a class="dropdown-item" href="/nhanvien/sp_nsx/{{$n->id_nsx}}">{{$n->ten_nsx}}</a></li>
                    @endforeach
                </ul>
            </div>
        </div>
        ...
        <div class="col-lg-2 col-md-6 mb-2">
    <a href="{{route('sanpham_nv.create')}}" type="button" class="btn btn-primary w-100">
                        ...
                        <table class="table table-hover table-responsive" id="productTable">
                            ...
                            <tbody>
                              ...
                              <tr>
                                    ...
                                    <td>{{ $tk->soLuong }}</td>
                                    <td><a href="{{ route('sanpham_nv.show', $tk->id_sp) }}" class="btn btn-success">Xem</a></td>
                                    <td>
                                        <form action="{{ route('sanpham_nv.destroy', $tk->id_sp) }}" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
                              ...
                              @else
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('sanpham_nv.show', $sanpham->id_sp) }}" class="btn btn-success">Xem</a></td>
                                    <td>
                                    <form action="{{ route('sanpham_nv.destroy', $sanpham->id_sp) }}" method="POST" style="display:inline;" onsubmit="return confirmDelete();">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-sm btn-danger">Xóa</button>
                                            </form>
