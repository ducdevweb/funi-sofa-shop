...
@section('noidungchinh')
      ...
      <div class="col-md-10 p-4">
          <!-- Cards -->
          <div class="row mb-4">
            <a href="#" class="text-decoration-none col-lg-3 col-md-6 mb-4">
            ...
            <a href="{{route('sanpham_nv.index')}}" class="text-decoration-none col-lg-3 col-md-6 mb-4">
            ...
            <a href="{{route('binhluan_nv.index')}}" class="text-decoration-none col-lg-3 col-md-6 mb-4">
                ...
                <table class="table table-hover table-responsive" id="productTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                      <a class="btn btn-sm btn-orange btn-view-product" href="{{route('sanpham_nv.show',$sp->id_sp)}}"> Xem</a>
