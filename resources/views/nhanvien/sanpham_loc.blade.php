                     ...
                     <tbody>
                           @if (isset($list_nsx))
                              ...
                              <tr>
                                    ...
                                    <td><a href="{{ route('sanpham_nv.show', $loc->id_sp) }}" class="btn btn-success">Xem</a></td>
                                    <td>
                                       <form action="{{ route('sanpham_nv.destroy', $loc->id_sp) }}" method="POST" style="display:inline;">
                                          @csrf
                                          @method('DELETE')
