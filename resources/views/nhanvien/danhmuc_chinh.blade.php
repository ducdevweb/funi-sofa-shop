...
<form action="{{ route('danhmuc_nv.update', $danhmuc->id_loaisp) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="mb-3">
    ...
    <a href="{{ route('danhmuc_nv.index') }}" class="btn btn-secondary">Hủy</a>
</form>
