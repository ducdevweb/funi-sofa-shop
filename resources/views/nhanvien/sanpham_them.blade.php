...
<form action="{{ route('sanpham_nv.store') }}" method="POST" enctype="multipart/form-data" class="col-md-10 mx-auto p-4 bg-light shadow-sm rounded">
    @csrf 
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="mb-3">
                <label for="editProductImage" class="form-label fw-bold">Hình ảnh</label>
