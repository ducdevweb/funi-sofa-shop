...
<div class="col-md-10 p-4">
    ...
    <div class="row mb-4">
    <form action="{{ route('baiviet_nv.index') }}" method="GET" class="col-lg-3 col-md-6 mb-4">
    ...
    <form action="{{ route('baiviet_nv.index') }}" method="GET" class="mb-4">
...
<form action="{{route('baiviet.index')}}" method="GET" class="row mb-4 align-items-end">
    ...
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('baiviet_nv.create') }}"><button class="btn btn-light">Thêm bài viết mới</button></a>
    </div>
            ...
            <tbody>
                @foreach ($baiviet_arr as $baiviet)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('baiviet_nv.show', $baiviet->id_bv) }}" class="btn btn-sm btn-primary">Xem</a>
                            <form action="{{ route('baiviet_nv.destroy', $baiviet->id_bv) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
