    ...
    <div class="col-md-10 p-4">
        <div class="row mb-4">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <form action="{{ route('binhluan.index') }}" method="GET">
                    @csrf
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <form action="{{ route('binhluan.show',0) }}" method="GET">
                    @csrf
    ...
    <div class="list-group-item">
        <div class="row">
            <div class="col-md-1 d-flex align-items-center">
                <img src="{{$binhluan->hinh_bl}}" class="img-comment" alt="Avatar">
            </div>
            <div class="col-md-9">
                ...
                <div class="product-info">
                    ...
                    <div class="btn-group">
                        <form action="{{ route('binhluan.destroy', $binhluan->id_bl) }}" method="POST" onsubmit="return confirmDelete()">
                            @csrf
                            @method('DELETE')
