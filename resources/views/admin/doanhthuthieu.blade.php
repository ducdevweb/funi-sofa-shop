...
<div class="container mt-5">
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white">
            <h2 class="mb-0">Báo Cáo Doanh Thu Còn Thiếu</h2>
        </div>

        <div class="card-body">
            <form action="{{ route('doanhthuthieu') }}" method="GET" class="mb-4">
                <div class="row">
                    <div class="col-md-3">
            ...
            <h4>Tổng Doanh Thu: {{ number_format($tongdoanhthuthieu, 0, ',', '.') }} VNĐ</h4>
            ...
            <table class="table table-bordered mt-4">
                ...
                <tbody>
                    @foreach ($doanhthuthieu as $thongtin)
                    <tr>
