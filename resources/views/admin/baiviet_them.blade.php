...
<form method="post" action="{{ route('baiviet.store') }}" enctype="multipart/form-data" class="col-md-10">
    @csrf  
    <div class="comment">
        <div class="row mb-4">
                ...
                <div class="card shadow" style="border-radius: 10px;">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="postTitle" name="tieu_de" placeholder="Nhập tiêu đề bài viết" >
                        </div>

                        <div class="mb-3">
                            <label for="author" class="form-label">Tác Giả</label>
                            <input type="text" class="form-control" id="author" name="tac_gia" placeholder="Nhập tên tác giả" >
                        </div>

                        <div class="mb-3">
                            <label for="postContent" class="form-label">Nội Dung Bài Viết</label>
                            <textarea class="form-control" id="postContent" name="noi_dung" rows="5" placeholder="Nhập nội dung bài viết" ></textarea>
                        </div>  
